                        ...
                        <div class="card-header border-0 pb-0">
                            <ul class="nav nav-tabs nav-tabs-line card-header-tabs" role="tablist">
                                <li class="nav-item w-50 text-center" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#messages" role="tab" aria-selected="true">Messages</a>
                                </li>
                                <li class="nav-item w-50 text-center" role="presentation">
                                    <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#contacts" role="tab" aria-selected="false">Contacts</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card h-100 mb-2">
                        <div class="card-body d-flex flex-column h-100 w-100 position-relative">
                            ...
                            <div class="d-flex flex-row align-items-center mb-3">
                                <div class="row g-0 sh-6 align-self-start" id="contactTitle">
                                    <div class="col-auto">
                                        <div class="sh-6 sw-6 d-inline-block position-relative">
                                            <img src="<?= base_url() ;?>dashboard/img/profile/profile-11.webp" class="img-fluid rounded-xl border border-2 border-foreground profile" alt="thumb" />
                                ...
                                <button type="button" class="btn btn-outline-primary btn-icon btn-icon-only ms-1 ms-auto" id="callButton" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Call" data-delay='{"show":"250", "hide":"0"}'>
                                    <i data-acorn-icon="phone"></i>
                                </button>
                                <button type="button" class="btn btn-outline-primary btn-icon btn-icon-only ms-1" id="videoCallButton" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Video Call" data-delay='{"show":"250", "hide":"0"}'>
                    ...
                    <div class="bg-vertical-ornament-3 w-100 h-100 d-flex flex-column justify-content-between align-items-center">
                        <div class="card-body d-flex align-items-center flex-column flex-grow-1 w-100">
                            <div class="sw-10 mb-2 position-relative">
                                <img src="<?= base_url() ;?>dashboard/img/profile/profile-1.webp" class="img-fluid rounded-xl border border-2 border-foreground profile" alt="thumb" />
                            </div>
        ...
        <a href="#" class="row w-100 d-flex flex-row g-0 sh-5 mb-2 nav-link p-0 contact-list-item">
            <div class="col-auto">
                <div class="sw-5 d-inline-block position-relative">
                    <img src="<?= base_url() ;?>dashboard/img/profile/profile-1.webp" class="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" id="contactImage" />
            ...
            <div class="row g-2">
                <div class="col-auto d-flex align-items-end">
                    <div class="sw-5 sh-5 mb-1 d-inline-block position-relative">
                        <img src="<?= base_url() ;?>dashboard/img/profile/profile-1.webp" class="img-fluid rounded-xl chat-profile" alt="thumb" />
                    </div>
                </div>
    ...
    <template id="respondAttachmentContentTemplate">
        <div class="d-inline-block sh-11 me-2 position-relative pb-4 rounded-md bg-separator-light text-alternate">
            <a href="" data-caption="cupcake.webp" class="lightbox h-100 attachment">
                <img src="<?= base_url() ;?>dashboard/img/product/small/product-4.webp" class="h-100 rounded-md-top" />
            </a>
        ...
        <div class="mb-2 card-content">
            <div class="row g-2">
                <div class="col-auto d-flex align-items-end order-1">
                    <div class="sw-5 sh-5 mb-1 d-inline-block position-relative">
                        <img src="<?= base_url() ;?>dashboard/img/profile/profile-2.webp" class="img-fluid rounded-xl" alt="thumb" />
                    </div>
                </div>
