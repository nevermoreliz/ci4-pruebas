    ...
    <div class="nav-content d-flex">
        ...
        <div class="logo position-relative">
            <a href="Dashboards.Default.html">
                ...
                <!-- <img src="<?= base_url() ;?>dashboard/img/logo/logo-white.svg" alt="logo" /> -->
        ...
        <div class="user-container d-flex">
            <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="profile" alt="profile" src="<?= base_url() ;?>dashboard/img/profile/profile-9.webp" />
        ...
        <div class="menu-container flex-grow-1">
            <ul id="menu" class="menu">
                <li>
                    ...
                    <ul id="dashboards">
                        <li>
                            <a href="<?= base_url(route_to('uno')) ;?>" class="menu--link">
                                <span class="label">Default</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= base_url(route_to('dos')) ;?>" class="menu--link">
