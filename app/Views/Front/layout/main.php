...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>dashboard/css/vendor/introjs.min.css" />

    <link rel="stylesheet" href="<?= base_url(); ?>dashboard/css/vendor/select2.min.css" />

    <link rel="stylesheet" href="<?= base_url(); ?>dashboard/css/vendor/select2-bootstrap4.min.css" />

    <link rel="stylesheet" href="<?= base_url(); ?>dashboard/css/vendor/plyr.css" />
