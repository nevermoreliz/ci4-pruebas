                    ...
                    <div class="scroll-by-count" data-count="6">
                            ...
                            <div class="row g-0 sh-12">
                                <div class="col-auto">
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-1.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 sh-12">
                                <div class="col-auto position-relative">
                                    ...
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-2.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 sh-12">
                                <div class="col-auto">
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-3.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 sh-12">
                                <div class="col-auto">
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-4.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 sh-12">
                                <div class="col-auto">
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-5.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 sh-12">
                                <div class="col-auto">
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-6.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 sh-12">
                                <div class="col-auto">
                                    <a href="Pages.Portfolio.Detail.html">
                                        <img src="<?= base_url(); ?>dashboard/img/product/small/product-7.webp" alt="alternate text" class="card-img card-img-horizontal sw-13 sw-lg-15" />
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
        ...
        <div class="row">
            <div class="col-12 col-md-4 mb-5">
                <div class="card w-100 sh-18 sh-md-22 hover-img-scale-up">
                    <img src="<?= base_url(); ?>dashboard/img/banner/cta-standard-1.webp" class="card-img h-100 scale" alt="card image" />
            ...
            <div class="col-12 col-md-4 mb-5">
                <div class="card w-100 sh-18 sh-md-22 hover-img-scale-up">
                    <img src="<?= base_url(); ?>dashboard/img/banner/cta-standard-2.webp" class="card-img h-100 scale" alt="card image" />
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                        <div class="d-flex flex-column h-100 justify-content-between align-items-start">
                            <div class="cta-3 text-black">
                                Basic Principles
            ...
            <div class="col-12 col-md-4 mb-5">
                <div class="card w-100 sh-18 sh-md-22 hover-img-scale-up">
                    <img src="<?= base_url(); ?>dashboard/img/banner/cta-standard-3.webp" class="card-img h-100 scale" alt="card image" />
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                        <div class="d-flex flex-column h-100 justify-content-between align-items-start">
                            <div class="cta-3 text-black">
                                Easy & Practical
